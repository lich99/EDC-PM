# -*- coding: utf-8 -*-
"""
Created on Sun Jan 19 21:32:29 2020
...
def set_zero_boundary(num, max_x, max_y):
    ...
    b[:, :, -1, :] = 0
    # return tf.expand_dims( tf.convert_to_tensor(b, dtype = dtype), axis = 3)
...
def run(Iter, n):
    ...
    # re_zero_boundary = 1 - zero_boundary
    rho = Init_rho(drug)
...
rho, rho_left, rho_accu, _ = run(Iter, args.n)
